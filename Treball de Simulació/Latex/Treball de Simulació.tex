...
Si escollim $r_0 = 0,01$ m, s'obtenen els resultats de la \ref{fig:1.4}.
...
Si escollim $r_0 = 0,03$ m, s'obtenen els resultats de la figura \ref{fig:1.5}.

\begin{figure}[h]
	\centering
	\includegraphics[width=0.5\linewidth]{dis_vels_r_0.03}
	\caption{Distribució de velocitats per $r_0 = 0,03$ m després de 5 minuts de simulació}
	\label{fig:1.5}
\end{figure}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.5\linewidth]{dis_vels_r_0.03_T=20min}
	\caption{Distribució de velocitats per $r_0 = 0,03$ m després de 20 minuts de simulació}
	\label{fig:disvelsr0}
\end{figure}

\textbf{ESTARIA GUAY POSAR AQUESTES DUES FOTOS FINALS AL COSTAT JA QUE REPRESENTEN EL MATEIX}
\textbf{FER TAULA AMB COMPARATIVA DE RESULTATS. ESTUDIAR \% DE VOLUM DE LA CAIXA OCUPAT}
