...
\subsection{Anàlisi de la distribució d'energies}
Un cop tenim implementat el termostat d'Andersen, convé estudiar quina és la distribució d'energies obtinguda i comparar-la amb l'esperada teòricament per saber així si tot plegat ha funcionat. La distribució teòrica d'energies $\rho(E)$ es pot deduir a partir de la distribució de velocitats de Maxwell-Boltzmann tot considerant que
\begin{equation}
	E = \frac{1}{2}mv^2,
\end{equation}
