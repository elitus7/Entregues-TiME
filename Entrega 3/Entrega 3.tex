...
\end{equation}
Una forma de comprovar si els resultats que hem trobat són coherents és veure què passar per a certs valors de $s$ característics. 

Si $s=2$, aleshores el hamiltonià esdevé 
\begin{equation}
	H = ap^2,
\end{equation}
que, identificant la constant $a$ amb $\frac{1}{2m}$, recuperem el hamiltonià del gas ideal monoatòmic (per una partícula). La corresponent funció de partició és, usant el que hem trobat a \eqref{eq:11}
\begin{equation}
