...
\label{eq15}
\end{equation}
\textcolor{red}{\textbf{A l'enunciat diu que s'ha d'expressar en termes de la densitat del sistema$\ldots$ No se si això també o no, ho he de pensar. Estoy cansao jefe// Jo crec que no perquè no apareix el volum ni res així, només tenim les variables de l'enunciat}}
...
\end{equation*}
i, per tant, la condició es converteix en
\begin{equation}
	\frac{1}{\rho^{\frac{1}{3}}} >> \lambda_T.
\end{equation}
Substituint per l'expressió de la longitud d'ona de De Broglie obtinguda (equació \eqref{eq15}), obtenim
\begin{equation}
	\frac{1}{\rho^{\frac{1}{3}}} >> h(\beta a)^\frac{1}{s}\left(\frac{s}{4\pi \Gamma(\frac{3}{s})}\right)^{\frac{1}{3}}.
\end{equation}
...
Així, trobem que
\begin{equation}
	\boxed{T >> \frac{ah^s}{k_B}\cdot \left(\frac{s\rho}{4\pi\cdot\Gamma\left(\frac{3}{s}\right)}\right)^{\frac{s}{3}}}.
\end{equation}
